 ...
 * :[3, 4, 5, 6]
 */
#if TAOLI_SERIAL && TRONXY_PROJ != PROJ_TAONI
...
#define EXTRUDERS 2
#elif TRONXY_PROJ == PROJ_XY2_PRO_3E || TRONXY_PROJ == PROJ_X5SA_PRO_3E
#define EXTRUDERS 3
#else
#define EXTRUDERS 1
#endif
...
//初始:d = 0, si = 0
//error = target - now 目标温度与当前温度之差
//dd = last - now 上次温度与当前温度之差
//si += error 累积误差
//p = kp * error
//i = si * ki
//d = (1 - PID_K1) * kd * dd  + d * PID_K1
//pid_out = p + i + d;
//保证:pid_out <= PID_MAX
#endif // PIDTEMP
...
#elseif TRONXY_PROJ== PROJ_X5SA_PRO
 ...
 */
#if TRONXY_PROJ == PROJ_X5SA /*g*/\
|| TRONXY_PROJ == PROJ_C2 \
|| TRONXY_PROJ == PROJ_X5SA_g \
|| TRONXY_PROJ == PROJ_X5SA_MINI
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 197.48 } //XY20齿换16次:160->200
#elif TRONXY_PROJ == PROJ_XY2_PRO
  #if USE_EXTRUDER == 2 //B:BMG
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 815.3 }
...
|| TRONXY_PROJ == PROJ_X5SA_PRO_3E
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 177.8, 177.8, 177.8, 365.0 } //xyz 16细分,同丝杆18导程
...
#elif /*TRONXY_PROJ== PROJ_K1M ||*/ TRONXY_PROJ == PROJ_HS
  #define DEFAULT_MAX_FEEDRATE          { 400, 400, 40, 40 }
#else
  #define DEFAULT_MAX_FEEDRATE          { 150, 150, 15, 150 }
#endif
 ...
 */
  ...
  #endif
#elif /*TRONXY_PROJ== PROJ_K1M ||*/ TRONXY_PROJ == PROJ_HS
  #define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 200, 2000 }
#else
 ...
 */
#if /*TRONXY_PROJ== PROJ_K1M ||*/ TRONXY_PROJ == PROJ_HS
...
#define CLASSIC_JERK
  ...
  #else
  #define DEFAULT_XJERK  15.0 //10.0->15.0
...
#define DEFAULT_EJERK    12.0  // 打开线性算法LIN_ADVANCE这里需要大于10 May be used by Linear Advance
...
&& TRONXY_PROJ != PROJ_X5SA500_2E \
&& TRONXY_PROJ != PROJ_HS
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //单独使用PROBE作复位
#endif
...
#elif TRONXY_PROJ == PROJ_HS
#define NOZZLE_TO_PROBE_OFFSET { 24.2, 37.7, 0 }
#else
...
//YSZ-COMMENT:当探头下降低于复位的0点Z_PROBE_LOW_POINT时,会停止,并探底失败
...
#if TRONXY_PROJ == 1 \
|| TRONXY_PROJ == PROJ_XY2_PRO \
|| TRONXY_PROJ == PROJ_XY3_PRO \
|| TRONXY_PROJ == PROJ_XY3_SE \
|| TRONXY_PROJ == PROJ_XY3SE_2E \
|| TRONXY_PROJ == PROJ_XY2_PRO_2E \
...
#if TRONXY_PROJ == PROJ_XY2_PRO /*C*/
  #if USE_EXTRUDER == 2
  #define INVERT_E0_DIR true
  #elif USE_EXTRUDER == 4
  #define INVERT_E0_DIR false
  #else
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_X5SA_MINI /*g*/
  #if USE_EXTRUDER == 4
  #define INVERT_E0_DIR true
  #else
  #error "Extruder error."
...
|| TRONXY_PROJ == PROJ_X5SA_g
  ...
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_XY3_PRO/*T*/\
|| TRONXY_PROJ == PROJ_X5SA_2E \
|| TRONXY_PROJ== PROJ_K1M \
|| TRONXY_PROJ == PROJ_XY2_PRO_2E \
|| TRONXY_PROJ == PROJ_X5SA400_PRO \
...
|| TRONXY_PROJ == PROJ_X5SA_PRO_3E
  ...
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_XY3_SE /*C*/\
|| TRONXY_PROJ == PROJ_D01_PLUS \
|| TRONXY_PROJ == PROJ_XY3SE_2E \
|| TRONXY_PROJ == PROJ_X5SA_PRO \
|| TRONXY_PROJ == PROJ_XY3SE_V2 \
|| TRONXY_PROJ == PROJ_HS
  ...
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_XY3_PRO_V2 /*B*/
  #if USE_EXTRUDER == 2
  #define INVERT_E0_DIR true
  #else
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_X5SA600 /*B*/
  #if USE_EXTRUDER == 2
  #define INVERT_E0_DIR false
  #else
  #error "Extruder error."
  #endif
#elif TRONXY_PROJ == PROJ_MOORE1 /*t*/\
|| TRONXY_PROJ == PROJ_MOORE2_PRO \
|| TRONXY_PROJ == PROJ_TAONI
  #if USE_EXTRUDER == 3
  #define INVERT_E0_DIR true
  ...
  #endif
#else
  #error "You need choose right TRONXY_PROJ!"
#endif
...
#if TRONXY_PROJ == PROJ_XY2_PRO_3E \
|| TRONXY_PROJ == PROJ_X5SA_PRO_3E
